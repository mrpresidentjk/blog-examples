...
const Student = () => {
    ...
    const courses = data && data.student.length ? data.student[0].courses : [];
    return (
        <div className="px-4 sm:px-6 lg:px-8">
            <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    <h1 className="text-xl font-semibold text-gray-900">{data?.student[0].firstName} {data?.student[0].lastName}</h1>
